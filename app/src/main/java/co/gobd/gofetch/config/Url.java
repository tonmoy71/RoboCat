...
public class Url {
    ...
    public static final String PATH_SUPPORTED_ORDER = "/api/Order/SupportedOrder.json";
    public static final String BASE_URL_TASK_CAT = "http://taskcatdev.azurewebsites.net";
