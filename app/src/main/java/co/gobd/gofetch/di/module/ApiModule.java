...
@Module public class ApiModule {
  ...
  @Provides @Singleton public GsonConverterFactory providesGsonConverterFactory() {
  ...
  @Provides @Singleton @Named(Constant.BackendName.TASK_CAT)
  public Retrofit providesRetrofitForTaskCat(OkHttpClient okHttpClient,
      GsonConverterFactory factory) {
    return new Retrofit.Builder().baseUrl(ApiEndpoint.TaskCat.BASE)
        .client(okHttpClient)
