...
public class AccountServiceImpl implements AccountService {
  ...
  @Override public void register(UserModel userModel, final RegistrationCallback callback) {
  ...
  @Override public void login(String userName, String password, final LoginCallback callback) {
    Call<AccessToken> call =
        accountApi.login(userName, password, Constant.Login.GRANT_TYPE, Constant.Login.CLIENT_ID,
  ...
  @Override public void getProfile(String bearer, ProfileCallback callback) {
